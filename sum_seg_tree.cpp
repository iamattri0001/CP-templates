...
int main()
{
    ...
    updateLazy(4, 7, 10, tree, 0, n - 1); // range update
    updateLazy(4, 4, 10, tree, 0, n - 1); // point update

    cout << queryLazy(0, n - 1, tree, 0, n - 1) << endl;
}
